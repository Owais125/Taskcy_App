...
const Slider_Tow = () => {
    ...
    const next = () => {
        navigation.navigate('slider-three')
    }
    const login = () => {
    ...
    return (
        <KeyboardAvoidingView
            ...
            <ScrollView>
                <View>
                    <Image resizeMode='cover' style={{ height: 450 }} source={require("../assets/Image3.jpeg")} />
                    <View style={{ paddingHorizontal: 20 }}>
                        <Text style={{ fontSize: 25, fontWeight: 'bold', color: '#756ef3' }}>
                            Task Management
                        </Text>
                        <Text style={{ fontSize: 40 }}>Work more <Text style={{ color: '#756ef3' }}>Structured </Text>and  Organized 👌
                        </Text>
